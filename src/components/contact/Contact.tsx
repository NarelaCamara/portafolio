  ...
  return (
    <div className="flex flex-col justify-start">
      <div className="relative">
        <span className="flex flex-row justify-start  py-2  w-full  rounded-lg text-start leading-tight   font-normal text-base transition-all duration-[0.5s] transform-gpu hover:font-bold hover:scale-110 hover:translate-x-[-10px]">
